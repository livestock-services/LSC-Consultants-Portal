<template>
         ...
         <b-form class="form">
            ...
            <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag earTagID "> {{waterPump.waterPumpClientName}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag breed "> {{waterPump.waterPumpClientPhoneNumber}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag  is-light"> {{waterPump.waterPumpClientLocation}} </span>
             ...
             <div  class="column is-half">
              ...
              <p >
               <span class="tag age "> {{waterPump.waterPumpClientTown}} </span>
             ...
             <div  class="column is-half">
              ...
              <p >
              <span class="tag is-info" > {{waterPump.waterPumpCategory}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span style="font-size: small;" aria-multiline="true"> {{waterPump.waterPumpClientComments}} </span>
  ...
  export default {
    ...
    methods: {
      ...mapActions('waterPumpData', ['load', 'selectWaterPumpRecord']),
  
      async onSubmit() {
         await this.putwaterPumpInTreatment();
       ...
       async onTreated() {
        ...
        await this.markwaterPumpAsTreated();
         const msg = await Promise.resolve('Operation successful')
   ...
   onMortality(){
    console.log("Pegged!")
      ...
      close() {
        this.$buefy.toast.open({
          message: 'Water Pump Snapshot closed.',
          duration: 2000,
          position: 'is-top',
          type: 'is-warning ',
        })

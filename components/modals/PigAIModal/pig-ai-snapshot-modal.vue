<template>
         ...
         <b-form class="form">
            ...
            <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag earTagID "> {{pigAI.pigAIClientName}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag breed "> {{pigAI.pigAIClientPhoneNumber}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag  is-light"> {{pigAI.pigAIClientLocation}} </span>
             ...
             <div  class="column is-half">
              ...
              <p >
               <span class="tag age "> {{pigAI.pigAIClientTown}} </span>
             ...
             <div  class="column is-half">
              ...
              <p >
              <span class="tag is-info" > {{pigAI.pigAICategory}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span style="font-size: small;" aria-multiline="true"> {{pigAI.pigAIClientComments}} </span>
  ...
  export default {
    ...
    methods: {
      ...mapActions('pigAIData', ['load', 'selectPigAIRecord']),
  
      async onSubmit() {
         await this.putPigAIInTreatment();
   ...
   onMortality(){
    console.log("Pegged!")
      ...
      close() {
        this.$buefy.toast.open({
          message: 'Pig AI Snapshot closed.',
          duration: 2000,
          position: 'is-top',
          type: 'is-warning ',
        })

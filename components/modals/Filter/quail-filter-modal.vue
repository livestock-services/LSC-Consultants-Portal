<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="quailPostMortemFilterForm" class="form">
...
>>>>>>> 63821e9a05e8546f42e9f145a46cbd43d923a221
     ...
     computed: {
        ...
        ...mapFields('vetData', [
        'quailPostMortemFilterForm',
        'quailPostMortemFilterForm.startDate',
        'quailPostMortemFilterForm.endDate'
    ...
    methods: {
        ...mapActions('vetData', ['getFilteredQuailPMRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredQuailPMRecords();

<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="layerChickenPostMortemFilterForm" class="form">
  ...
  export default {
    name: 'LayerFilterModal',
     ...
     computed: {
        ...
        ...mapFields('vetData', [
        'layerChickenPostMortemFilterForm',
        'layerChickenPostMortemFilterForm.startDate',
        'layerChickenPostMortemFilterForm.endDate'
    ...
    methods: {
        ...mapActions('vetData', ['addNewVillageChickenPMRecord','getFilteredLayerChickenPMRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredLayerChickenPMRecords();

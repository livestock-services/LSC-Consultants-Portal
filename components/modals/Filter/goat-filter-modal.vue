<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="goatPostMortemFilterForm" class="form">
  ...
  export default {
    name: 'GoatFilterModal',
     ...
     computed: {
        ...
        ...mapFields('vetData', [
        'goatPostMortemFilterForm',
        'goatPostMortemFilterForm.startDate',
        'goatPostMortemFilterForm.endDate'
    ...
    methods: {
        ...mapActions('vetData', ['getFilteredGoatPMRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredGoatPMRecords();

<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="pigPostMortemFilterForm" class="form">
...
>>>>>>> 63821e9a05e8546f42e9f145a46cbd43d923a221
     ...
     computed: {
        ...
        ...mapFields('vetData', [
        'pigPostMortemFilterForm',
        'pigPostMortemFilterForm.startDate',
        'pigPostMortemFilterForm.endDate'
    ...
    methods: {
        ...mapActions('vetData', ['getFilteredPigPMRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredPigPMRecords();

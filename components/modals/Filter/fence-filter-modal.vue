<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="fenceFilterForm" class="form">
  ...
  <div class=" card my-4 ">
     ...
     <div class=" summary-content">
       <h2 class="tag is-info is-light mx-4 mb-4 summary">Summary</h2><br/>
        ...
        <div class="ml-4">
            <h4>Selecting all Fence Consultations from:</h4> 
        </div>
  ...
  export default {
    name: 'FenceFilterModal',
     ...
     computed: {
        ...
        ...mapFields('fenceData', [
        'fenceFilterForm',
        'fenceFilterForm.startDate',
        'fenceFilterForm.endDate'
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredFenceRecords();

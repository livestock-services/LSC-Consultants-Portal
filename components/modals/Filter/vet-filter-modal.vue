<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="vetFilterForm" class="form">
...
// },
    ...
    ...mapFields('vetData', [
        'vetFilterForm',
        'vetFilterForm.startDate',
        'vetFilterForm.endDate'
    ...
    methods: {
        ...
        ...mapActions('vetData', ['addNewVetRecord','getAllVetRecords','getFilteredVetRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredVetRecords();

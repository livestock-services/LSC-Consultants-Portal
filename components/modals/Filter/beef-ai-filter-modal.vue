<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="beefAIFilterForm" class="form">
  ...
  <div class=" card my-4 ">
     ...
     <div class=" summary-content">
       <h2 class="tag is-info is-light mx-4 mb-4 summary">Summary</h2><br/>
        ...
        <div class="ml-4">
            <h4>Selecting all Beef AI Consultations/Sales from:</h4> 
        </div>
...
>>>>>>> 63821e9a05e8546f42e9f145a46cbd43d923a221
     ...
     computed: {
        ...
        'beefAIFilterForm',
        'beefAIFilterForm.startDate',
        'beefAIFilterForm.endDate'
    ...
    methods: {
        ...mapActions('beefAIData', ['getFilteredBeefAIRecords', 'load']),
     ...
     loading() {
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          title: 'Get Consultations/Sales Results',
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredBeefAIRecords();

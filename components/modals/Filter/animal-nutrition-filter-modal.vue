<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="nutritionFilterForm" class="form">
 ...
 <b-button @click="onGetResult" type="is-info">Get Results</b-button>
  ...
  export default {
    ...
    ...mapFields('nutritionData', [
        'nutritionFilterForm',
        'nutritionFilterForm.startDate',
        'nutritionFilterForm.endDate'
    ...
    methods: {
        ...
        ...mapActions('nutritionData', ['addNewNutritionRecord','getFilteredNutritionRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredNutritionRecords();

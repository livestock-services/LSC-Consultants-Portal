<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="totalConsultsFilterForm" class="form">
 ...
 <b-button @click="onGetResult" type="is-info">Get Results</b-button>
  ...
  export default {
    ...
    ...mapFields('totalConsultsData', [
        'totalConsultsFilterForm',
        'totalConsultsFilterForm.startDate',
        'totalConsultsFilterForm.endDate'
      ...
      ...mapGetters('totalConsultsData', {
         totalConsults: 'selectedtotalConsultsRecord',
        totalConsultsLoading: 'loading',
      }),

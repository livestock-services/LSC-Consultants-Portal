<template>
    <div class="modal-card ">
      ...
      <section class="modal-card-body has-background-white">
        <!-- Modal Content -->
        <div>
            <b-form v-model="rabbitPostMortemFilterForm" class="form">
  ...
  export default {
    name: 'RabbitFilterModal',
     ...
     computed: {
        ...
        'rabbitPostMortemFilterForm.startDate',
        'rabbitPostMortemFilterForm.endDate'
    ...
    methods: {
        ...mapActions('vetData', ['getFilteredRabbitPMRecords', 'load']),
      ...
      async onGetResult() {
         ...
         await this.$buefy.dialog.confirm({
          ...
          onConfirm: async () => {
           ...
           await this.getFilteredRabbitPMRecords();
     ...
     const notification = new Notification("Task data added.", {
      ...
      clearForm() {
       ...
       this.rabbitPostMortemFilterForm = {

<template>
      ...
      <section class="modal-card-body has-background-white">
        ...
        <div>
         <b-form class="form">
          ...
          <div v-if="beefAI.beefAIConsultingPerson !== 'Other'" class="columns">
           <div  class="column is-half">
             <h4> <span class="toggle is-blue"> Consulting Person</span></h4>
            <p >
             <span class="tag earTagID "> {{beefAI.beefAIConsultingPerson}} </span>
         ...
         <div v-if="beefAI.beefAIConsultingPerson === 'Other'" class="columns">
           <div  class="column is-half">
             <h4> <span class="toggle is-blue"> Consulting Person</span></h4>
            <p >
             <span class="tag earTagID "> {{beefAI.beefAIOtherConsultingPerson}} </span>
            ...
            <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag earTagID "> {{beefAI.beefAIClientName}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag breed "> {{beefAI.beefAIClientPhoneNumber}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span class="tag  is-light"> {{beefAI.beefAIClientLocation}} </span>
             ...
             <div  class="column is-half">
              ...
              <p >
               <span class="tag age "> {{beefAI.beefAIClientTown}} </span>
             ...
             <div  class="column is-half">
              ...
              <p >
              <span class="tag is-info" > {{beefAI.beefAICategory}} </span>
           ...
           <div class="columns">
             <div  class="column is-half">
              ...
              <p >
               <span style="font-size: small;" aria-multiline="true"> {{beefAI.beefAIClientComments}} </span>
  ...
  export default {
    ...
    methods: {
      ...mapActions('beefAIData', ['load', 'selectBeefAIRecord']),
  
      async onSubmit() {
         await this.putbeefAIInTreatment();
       ...
       async onTreated() {
        ...
        await this.markbeefAIAsTreated();
         const msg = await Promise.resolve('Operation successful')

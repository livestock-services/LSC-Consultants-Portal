    ...
    <section class="modal-card-body has-background-white">
      ...
      <div>
       <b-form class="form">
        ...
        <div v-if="fence.fenceConsultingPerson !== 'Other'" class="columns">
           <div  class="column is-half">
             <h4> <span class="toggle is-blue"> Consulting Person</span></h4>
            <p >
             <span class="tag earTagID "> {{fence.fenceConsultingPerson}} </span>
         ...
         <div v-if="fence.fenceConsultingPerson === 'Other'" class="columns">
           <div  class="column is-half">
             <h4> <span class="toggle is-blue"> Consulting Person</span></h4>
            <p >
             <span class="tag earTagID "> {{fence.fenceOtherConsultingPerson}} </span>

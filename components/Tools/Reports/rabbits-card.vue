    ...
    <div class="card  my-4">
      <header class="card-header footy my-4">
        <h1 class="card-header-title  header-text">
         Rabbit Post Mortems between <span class="tag is-info is-light"> {{ startTime }} </span> and <span class="tag is-info is-light"> {{ endTime }} </span>
        </h1>
      </header>
     ...
     <b-tooltip label="Export to Excel" type="is-dark">
      ...
      <download-excel
       :data="rabbit_data" 
       :fields="rabbit_fields"
       worksheet="Rabbit Worksheet"
       type="xls"
       name = "Rabbit Post Mortems.xls">
      ...
      <b-form v-model="rabbitCard" class="card-content mx-4 my-4">
        <div class="content mx-6 has-text-left">
          
          <div class="columns">
            <div class=" my-4 pl-4">
           Coccidiosis:
               <b-field  class=" tag is-primary mx-4"> {{ rabbitCoccidiosis }}</b-field>
           
          </div>

           <div class=" my-4 pl-4">
              Bacterial Infection:
              <span class="tag is-primary mx-4 "> {{ rabbitBacterialInfection }}</span>
...
<script>
import RabbitFilterModal from '~/components/modals/Filter/rabbit-filter-modal.vue'
      ...
      return {
          ...
          rabbit_data:[
              ...
              { 
               ...
               { "consultation":"Bacterial Infection",
...
//let filteredAgros = await this.getFilteredAgroRecords();
 ...
 //console.log(filteredAgros)
  ...
  methods:{
      ...mapActions('vetData', ['getAllPostMortemRecords','getFilteredRabbitRecords', 'load']),

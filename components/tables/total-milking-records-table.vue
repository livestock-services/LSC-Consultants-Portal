<template>
  <div>
    ...
    >
      ...
      >
      <span class="tag is-primary is-light">{{ props.row.totalDMR}}</span>
     ...
     <b-table-column v-slot="props" label="Options">
      ...
      <template #empty>
        ...
        <h4 class="is-size-4 text-center has-text-centered">No Milking Data yet. &#x1F4DA;.Click the <span class="blue">blue refresh button</span> right above</h4>
        </b-tooltip>
...
// }
  ...
  methods: {
     ...
     ...mapActions('cattleData', ['addNewDMR','getAllDMRs', 'getAllCattle', 'getTotalMikingRecords', 'load', 'selectDMR']),
